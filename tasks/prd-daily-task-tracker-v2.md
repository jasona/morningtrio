# Product Requirements Document: MorningTrio v2
...
**MorningTrio** is a personal, offline-first web application for daily task management. It implements the MIT (Most Important Tasks) methodology, helping the user focus on their top 3 priorities each day while managing carryover of incomplete tasks.
...
### Technology Stack
- **Runtime:** Node.js
- **Frontend Framework:** React or Next.js (static export for PWA)
- **Styling:** Tailwind CSS
- **UI Components:** shadcn/ui (built on Radix UI primitives)
- **Local Storage:** IndexedDB via Dexie.js (lightweight IndexedDB wrapper)
- **Database:** SQLite via better-sqlite3 or sql.js (in-browser SQLite compiled to WebAssembly) for structured local storage
- **Offline:** Service Worker via Workbox
- **Drag-and-Drop:** @dnd-kit/core (accessible, lightweight drag-and-drop)

### Why This Stack
- **Node.js + React:** Familiar ecosystem, excellent tooling, fast development
- **Tailwind CSS:** Utility-first, rapid styling, small production bundle with purging
- **shadcn/ui + Radix UI:** Accessible, unstyled primitives with copy-paste components; fully customizable
- **Dexie.js:** Simple Promise-based IndexedDB API, great for offline-first apps
- **sql.js (optional):** If more complex querying is needed, sql.js provides SQLite in the browser via WASM
- **@dnd-kit:** Modern, accessible, React-native drag-and-drop with great touch support
...
- Tailwind CSS purging ensures minimal CSS bundle
- Next.js static export produces optimized, cacheable assets
...
| A4 | Node.js/React stack provides sufficient performance for this use case | Generally proven, low risk |
...
|---------|------|--------|---------|
| v1 | 2026-01-05 | AI Assistant | Initial PRD (Blazor/.NET stack) |
| v2 | 2026-01-15 | AI Assistant | Updated to Node.js/React/Tailwind/shadcn/Radix stack |
